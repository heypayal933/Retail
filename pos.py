...
try:
 ...
 if(b1=="Update"):
   ...
   db=client['retail']
   collection=db['pos']
   collection.update_many({'id':t1},{'$set':{'storeid':t2}})
 ...
 if(b1=="Allsearch"):
   ...
   print("<table border=1><tr><th>ID</th><th>StoreID</th></tr>")
   for x in collection.find({}):
     print("<tr><td>",x["id"],"</td><td>",x["storeid"],"</td></tr>")
 if(b1=="Psearch"):
   client=pymongo.MongoClient("mongodb://localhost:27017/")
   db=client['retail']
   collection=db['pos']
